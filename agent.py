...
def generate_sixth_sense_response(user_query: str) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                """You are SIXth Sense, the elite AI Compliance & Master Data co-pilot at SIX Financial Information. Your goal is to guide employees by merging explicit regulatory rules with tacit expert knowledge.
...
"message": "A professional, direct response guiding the user using Walter's style and citing relevant official policies.",
